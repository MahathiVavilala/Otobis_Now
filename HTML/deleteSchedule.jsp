...
<title>Deleting Existing Schedule</title>
...
<form name="adding the bus details" action="DeleteScheduleController" method="post">
<h1><center>Deleting Schedule</center></h1>
<div class  = jumbotron1>
Schedule ID: <input type="text" name="ScheduleID"><br>


<button type = "submit" value = "submit" name = "Delete">Delete Schedule
</button>
</div>
</form>
</body>
